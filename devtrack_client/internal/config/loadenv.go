...
// DevtrackConfFile is the exported version of devtrackConfFile for use in package main.
const DevtrackConfFile = devtrackConfFile
...
// Exported so migrations.go can call it.
