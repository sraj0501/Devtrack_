...
func (c *IPCClient) Connect() error {
	...
	timeoutSecs := config.GetIPCConnectTimeoutSecs()
...
func CreateTimerTriggerMessage(data trigger.TimerTriggerData) IPCMessage {
	msgData := map[string]any{
		"timestamp":     data.Timestamp,
...
func CreateTaskUpdateMessage(data trigger.TaskUpdateData) IPCMessage {
	msgData := map[string]any{
