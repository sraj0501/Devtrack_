...
|---|---|---|
| `devtrack_client/` | Go | **CLIENT** — binary, git monitor, scheduler, CLI, PM connectors, DevTrack Sage, alerts, Telegram bot |
...
Sage capture/knowledge, alerts, local SQLite, queueing, scheduling, and MCP are Go-native. Server-backed calls use
