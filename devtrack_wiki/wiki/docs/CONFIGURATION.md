...
## Daemon Configuration (devtrack)

The variables below apply to the `devtrack` daemon.
...
**What**: Directory where the `devtrack` binary lives (the `devtrack_client` clone directory)
**Format**: Absolute path
**Example**: `/home/user/devtrack_client`
**Required**: Usually

```bash
DEVTRACK_HOME=/home/user/devtrack_client
```
...
How Go daemon and Python backend communicate.
...
**Note**: If Python backend can't connect to Go daemon, fails with clear error
...
# ============================================
PROJECT_ROOT=/home/user/Documents/devtrack_client
DEVTRACK_WORKSPACE=${PROJECT_ROOT}
