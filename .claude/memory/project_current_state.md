...
**Version:** v3.0.0 (2026-06-04). Branch: `feat/client-server-decoupling`. GitHub (`sraj0501/Devtrack_`) sole source. Releases: `.\scripts\release.ps1 [-Bump patch|minor|major]`.
...
**Completed:** Phase 1 + Phase 2 (`abad449`) decoupling → ticket sync → runtime-narrative (`cac67a4`) → PG-1→PG-4 SQLAlchemy.
